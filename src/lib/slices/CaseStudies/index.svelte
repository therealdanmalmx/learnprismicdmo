...
<Bounded data-slice-type={slice.slice_type} data-slice-variation={slice.variation}>
	<h2 class="max-w-2-xl text-balance text-center text-5xl font-medium md:text-7xl">
		...
		{#each caseStudies as caseStudy, index}
			...
			>
				<div class="col-span-1 flex flex-col justify-center gap-4">
					...
					<PrismicLink
						document={caseStudy}
						class="afer:absolute z-10 after:inset-0 hover:underline"
					>
				...
				<div class={clsx('relative lg:col-span-2', index % 2 && 'md:-order-1')}>
					<div class="image-glow -left-4 bottom-8 bg-orange-500"></div>
