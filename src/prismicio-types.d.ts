...
/**
 * Item in *Bento → Default → Primary → Bentobox*
 */
export interface BentoSliceDefaultPrimaryBentoboxItem {
	/**
	 * Title field in *Bento → Default → Primary → Bentobox*
	 *
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: bento.default.primary.bentobox[].title
	 * - **Documentation**: https://prismic.io/docs/field#rich-text-title
	 */
	title: prismic.RichTextField;

	/**
	 * Body field in *Bento → Default → Primary → Bentobox*
	 *
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: bento.default.primary.bentobox[].body
	 * - **Documentation**: https://prismic.io/docs/field#rich-text-title
	 */
	body: prismic.RichTextField;

	/**
	 * Image field in *Bento → Default → Primary → Bentobox*
	 *
	 * - **Field Type**: Image
	 * - **Placeholder**: *None*
	 * - **API ID Path**: bento.default.primary.bentobox[].image
	 * - **Documentation**: https://prismic.io/docs/field#image
	 */
	image: prismic.ImageField<never>;

	/**
	 * Wide field in *Bento → Default → Primary → Bentobox*
	 *
	 * - **Field Type**: Boolean
	 * - **Placeholder**: *None*
	 * - **Default Value**: false
	 * - **API ID Path**: bento.default.primary.bentobox[].wide
	 * - **Documentation**: https://prismic.io/docs/field#boolean
	 */
...
export interface BentoSliceDefaultPrimary {
	...
	/**
	 * Bentobox field in *Bento → Default → Primary*
	 *
	 * - **Field Type**: Group
	 * - **Placeholder**: *None*
	 * - **API ID Path**: bento.default.primary.bentobox[]
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	bentobox: prismic.GroupField<Simplify<BentoSliceDefaultPrimaryBentoboxItem>>;
}
...
export interface CallToActionSliceDefaultPrimary {
	...
	/**
	 * Button_label field in *CallToAction → Default → Primary*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
...
/**
 * Item in *Integrations → Default → Primary → Integration_icons*
 */
export interface IntegrationsSliceDefaultPrimaryIntegrationIconsItem {
	/**
	 * Icon field in *Integrations → Default → Primary → Integration_icons*
	 *
	 * - **Field Type**: Select
	 * - **Placeholder**: *None*
	 * - **API ID Path**: integrations.default.primary.integration_icons[].icon
	 * - **Documentation**: https://prismic.io/docs/field#select
	 */
	icon: prismic.SelectField<'cloudflare' | 'npm' | 'github' | 'figma' | 'fly' | 'digital_ocean'>;
}
...
export interface IntegrationsSliceDefaultPrimary {
	...
	/**
	 * Integration_icons field in *Integrations → Default → Primary*
	 *
	 * - **Field Type**: Group
	 * - **Placeholder**: *None*
	 * - **API ID Path**: integrations.default.primary.integration_icons[]
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	integration_icons: prismic.GroupField<
		Simplify<IntegrationsSliceDefaultPrimaryIntegrationIconsItem>
	>;
}
...
declare module '@prismicio/client' {
	...
	namespace Content {
		export type {
			...
			HeroSliceDefault,
			IntegrationsSlice,
			IntegrationsSliceDefaultPrimaryIntegrationIconsItem,
